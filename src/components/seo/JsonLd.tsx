  ...
  useEffect(() => {
    ...
    script.text = JSON.stringify({
      ...
      "mainEntity": {
        "@type": "CreativeWork",
        "name": "Schizostimmys",
        "description": "Schizo-kawaii NFT collection on Ethereum",
        "dateCreated": "2026-06-01",
        "genre": ["Digital Art", "NFT", "Kawaii", "Schizo-kawaii"],
        "keywords": "NFT, Ethereum, schizo-kawaii, kawaii nft, crypto art, blockchain, digital collectibles"
      }
    });
